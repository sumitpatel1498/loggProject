...
module SchoolManagementExtension {
    ...
    export class PathwayCtrl extends wp.angularBase.BaseCtrl implements angular.IController {
        ...
        $scope: SchoolManagementExtension.IPathwayScope;
        private $mdDialog: any;
        constructor($scope: SchoolManagementExtension.IPathwayScope, private dataSvc: StudentDataService, $timeout, $mdDialog: any, $mdSelect: any, $mdToast: any) {
